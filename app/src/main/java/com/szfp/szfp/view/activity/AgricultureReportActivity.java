...
import com.szfp.szfp.adapter.AgriculAllAdapter;
...
public class AgricultureReportActivity extends BaseNoActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (DataUtils.isEmpty(list)){
            ...
            agriAllList.setAdapter(new AgriculAllAdapter(this,list));
        }
    ...
    private void addContent(Document document, Integer value) {
        ...
        while (i < value) {
            ...
            table.addCell(String.valueOf(list.get(i).getAmountCollected()));
            table.addCell(DataUtils.format2Decimals(String.valueOf(list.get(i).getAmount())));
            table.addCell(TimeUtils.milliseconds2String(list.get(i).getTime()));
