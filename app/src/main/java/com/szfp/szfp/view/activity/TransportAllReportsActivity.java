...
public class TransportAllReportsActivity extends BaseActivity {

    private static final String TAG ="TransportAllReportsActivity" ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = DbHelper.getAllListAccountReport();
        if (list!=null){
            fullAllReportList.setAdapter(new AccountReportAdapter(this,list));
    ...
    public void onClick() {
        if (!DataUtils.isEmpty(list)) {
            totalnoofpages = 0;
            //set Output path
            FILE_PATH = Environment.getExternalStorageDirectory().getPath() + SzfpApplication.DISK_CACHE_PATH+SzfpApplication.PDF +"ALL REPORTS.pdf";
            document = new Document(PageSize.A4);
            //Call Pdf RendererAsynTask to write into a document

            progressDialog = new ProgressDialog(TransportAllReportsActivity.this);
            ...
            allExport.setError("Please Enter the Record Size");
        }
